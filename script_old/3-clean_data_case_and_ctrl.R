## ---------------------------
##
## Script name: 3-clean_data_case_and_ctrl
##
...
peg_noob_nors_filter_total <- list(PEG_NOOB_nors_filter_case, 
                                PEG_NOOB_nors_filter_ctrl) %>% 
  bind_cols()

combined_resid_total <- list(combined_resid_case, 
                             combined_resid_ctrl) %>% 
  bind_cols()
