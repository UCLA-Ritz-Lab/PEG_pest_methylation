...
##### PD patients (n = 569)
![manhatton](figures/dmp_plot_case.png)
...
![scatter_correlation](figures/beta_correlation_plot.png)
...
datatable(dmp_count_total$total %>% 
          ...
          caption = "Table: EWAS analysis in study sample (n = 806)"
          )
```
...
datatable(dmp_count_case$total %>% 
          ...
          options = list(
            ...
            scrollX = TRUE, 
                         ...
                         # fixedHeader=TRUE,
                         className = 'dt-center', targets = 0:4),
          caption = "Table: EWAS analysis in PD patients (n = 569)"
          )
```
